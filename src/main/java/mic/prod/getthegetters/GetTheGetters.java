...
public class GetTheGetters {
	...
	/**
	 * An implementation of this handler must be passed to the constructor.
	 */
	 ...
	 */
	public void getTheGetters(Object objectToAnalyse)
	 ...
	 * collections. Every time we go a level down we append the name of the
	 * getter to previous path.
	 * 
	 * @param objectToAnalyse
	 * @param previousPath
	 * @throws IllegalAccessException
	 ...
	 * @throws IntrospectionException
	 */
	private void getTheGetters(Object objectToAnalyse, String previousPath)
		...
		if (addGetClassGetters) {
			propertyDescriptors = Introspector.getBeanInfo(
					objectToAnalyse.getClass()).getPropertyDescriptors();
		} else {
			// get all the getters except getClass.
			propertyDescriptors = Introspector.getBeanInfo(
					objectToAnalyse.getClass(), Object.class)
		...
		for (PropertyDescriptor propertyDescriptor : propertyDescriptors) {
			...
			Object value;
			try {
				value = propertyDescriptor.getReadMethod().invoke(
						objectToAnalyse, new Object[] {});
			...
			// if the object is null or if it's a primitive type we pass it to
			// the handler
	...
	/**
	 * A simple interface that you give to the GetTheGetters instance to handle
	 * a pair getter / value.
	 * 
	 * @author michael
	 * 
	...
	public interface GetterHandler {
		...
		/**
		 * Implements this method to decide what you do with the pair getter /
		 * value. In the JUnit sample we just print the result on the console.
		 * 
		 * @param getter
		 * @param value
		 */
	...
	/**
	 * Call true on this method il you want to operate also on the getClass
	 * method.
	 * 
