 ...
 */
public class GetTheGettersTest 
    extends TestCase
{
    /**
     ...
     */
    public void testApp() throws IllegalAccessException, InvocationTargetException, NoSuchMethodException, IntrospectionException
    {
        Obj1 obj1 = new Obj1();
