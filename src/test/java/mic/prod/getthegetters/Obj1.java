...
public class Obj1 {
	...
	private Obj2[] sousObjs =  new Obj2[] {
			new Obj2("p_1_3", "p_1_4"),
			new Obj2("p_2_3", "p_2_4"),
			new Obj2("p_3_3", "p_3_4"),
	};
	...
	public void setiThrowExceptionIfYouTryToGetMe(int iThrowExceptionIfYouTryToGetMe) {
